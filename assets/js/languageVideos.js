...
translate(language){
  if(language == "arabic"){
   ...
   document.getElementById("title").innerHTML = "تصفح أفضل الفديوهات";
   document.getElementById("findBook").innerHTML = "ابحث عن افضل الفديوهات";
   ...
   document.getElementById("english").innerHTML = "english";
     document.getElementById("title").innerHTML = "Browse the best videos";
   document.getElementById("findBook").innerHTML = "Find your favorite videos";
